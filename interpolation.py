...
if __name__ == '__main__':
    ...
    print(lang_interpolation_2d.evaluate_derivative_x([0.5, 0.75], [0.5, 0.75]))
    print(lang_interpolation_2d.evaluate_derivative_y([0.5, 0.75], [0.5, 0.75]))
    ...
    lang_interpolation_1d = lagrange_1d(nodes_x, func_vals)
    print(lang_interpolation_1d.evaluate(0.5))

    t0 = time.time()
    for i in range(1000):
        lang_interpolation_1d.evaluate(0.5)
